import { IncreseItem, decreseItem, RemoveItem, ClearCart } from '../store/CartSlice';
        ...
        return (
            <div className="max-w-3xl mx-auto p-6 bg-gray-100 min-h-screen">
                ...
                <div className="cart-items space-y-4">
                    {cart.map((val) => {
                        return (
                            <div key={val._id} className="flex justify-between items-center bg-white p-4 shadow rounded-lg">
                                <div className="flex items-center gap-6">
                                    <span className="text-lg font-semibold text-gray-800">
                                        {val.title.length > 11 ? val.title.slice(0, 11) + "..." : val.title}
                                    </span>
